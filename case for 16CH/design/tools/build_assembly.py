"""Rebuild Case files FreeCAD/assembly_16ch.FCStd = case + board, positioned.

    /Applications/FreeCAD.app/Contents/Resources/bin/freecadcmd build_assembly.py

The board solids are copied straight from 16ch_step.step and translated in Z
...
try:
    ...
    a = App.newDocument("assembly_16ch")
    ...
    print("assembly_16ch.FCStd: 2 case parts + %d board solids, lifted %.2f mm" % (n, Z))
except Exception:
    traceback.print_exc()
